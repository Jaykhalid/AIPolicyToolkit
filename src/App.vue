<template>
    ...
    <div class="container">
        <img class="navbar-brand logo-text"  src="assets/images/logo.svg" width="20%" alt="alternative" /> 
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ms-auto navbar-nav-scroll">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#details">FAQs</a>
                </li>
                <li class="nav-item">
            ...
            <span class="nav-item">
                <a class="btn-solid-sm" href="#login">Log In</a>
            </span>
        </div> 
    </div> 
    </nav>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-6">
                <div class="text-container">
                    <h1 class="h1-large">AI Driven Toolkit for <br/> AI Policy Development</h1>
                    <a class="btn-solid-lg" href="#services">Know More</a>
                </div>
            </div> 
            <div class="col-lg-6 col-xl-6">
                <div class="image-container">
                    <img class="img-fluid" src="assets/images/main-section.svg" alt="alternative" />
                </div> 
            </div> 
        </div> 
    </div> 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-sm-12">
                <p class="p-small statement">Copyright © <a href="#">Commonwealth Secretary </a></p>
            </div> 
            <div class="col-lg-3 col-md-12 col-sm-12">
                <p class="p-small statement">Distributed by <a href="https://sustainablelivinglab.org" target="_blank">Sustainable Living Lab </a></p>
            </div> 
        </div> 
    </div> 
    </div>
